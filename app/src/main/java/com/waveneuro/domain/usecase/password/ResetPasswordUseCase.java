...
//
//public class ResetPasswordUseCase extends ObservableUseCase<ResetPasswordResponse> {
//
...
//    }
//
//    public void execute(ResetPasswordRequest request, UseCaseCallback<ResetPasswordResponse> useCaseCallback) {
