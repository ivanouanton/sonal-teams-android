...
//        drawerLayout.setScrimColor(Color.TRANSPARENT);
    ...
    public void onClickAccountContainer() {
        ...
        this.dashBoardViewModel.processEvent(new DashboardViewEvent.AccountClicked());
    }
...
//        bottomNavigationView.setSelectedItemId(R.id.bottom_navigation_device);
        this.dashBoardViewModelConnection.processEvent(new DashboardViewEvent.DeviceClicked());
        drawerLayout.closeDrawer(GravityCompat.END);
    }
    ...
    public void onClickLogout() {
        drawerLayout.closeDrawer(GravityCompat.END);
        this.dashBoardViewModel.processEvent(new DashboardViewEvent.LogoutClicked());
    }
